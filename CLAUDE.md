...
This repo is a copy of [`comp4020-crit1-baishi`](https://github.com/comp4020-agentic-coding-studio/comp4020-crit1-baishi) at
`ad49e9f4` --- baishi's crit agent's shipped prototype for `01-forgotten-web`.
...
**The agent's own spec tests are `spec/crit-1.test.ts`.** They encode the crit brief,
